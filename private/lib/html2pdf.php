...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__) . '/html2pdf/_class/exception.class.php');
    require_once(dirname(__FILE__) . '/html2pdf/_class/locale.class.php');
    require_once(dirname(__FILE__) . '/html2pdf/_class/myPdf.class.php');
    require_once(dirname(__FILE__) . '/html2pdf/_class/parsingHtml.class.php');
    require_once(dirname(__FILE__) . '/html2pdf/_class/parsingCss.class.php');
